    ...
    public class UpdateTokenHandlerTests
    {
        ...
        public async Task TokenInCache_UserExist_Return()
        {
            ...
            memoryCache
                ...
                .Returns(true);
            var handler = new UpdateTokenHandler(TestDBContext.CreateContext(), memoryCache.Object, new TestTokenOptions());
        ...
        public async Task UnknownToken()
        {
            ...
            //Assert
            await Assert.ThrowsAsync<InvalidRefreshTokenException>(() => result);
        }
    }
}
